...
print('{}Valor do salário líquido: {} R${:.2f}'.format(' '*5,' '*10, salario_liq))
print('{}Para os gastos você deve destinar {} R${:.2f}'.format(' '*5,' '*10, gastos))
print('{}Para os investimentos a longo prazo você deve destinar {} R${:.2f}'.format(' '*5,' '*10, longo_prazo))
print('{}Para os investimentos a curto prazo você deve destinar {} R${:.2f}'.format(' '*5,' '*10, curto_prazo))
print('{}E livre você tem: {} R${}'.format(' '*5,' '*10, livre))
print('')
